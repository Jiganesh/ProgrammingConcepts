...
Popular Database from AWS providing consistent performance at any scale
...
Goal behind DynamoDB  :  DynamoDB was conceptualized with one goal in mind provides consistent performance at any scale, low single digit millisecond latency

...
- Can only consist A-Z, a-z, 0-9, $, _, (If we are using any other character we will get compile time error)
...
- goto (usage of goto created several problems in old languages and hence it was banned)
